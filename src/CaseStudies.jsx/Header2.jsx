...
<div className="flex3boxes">
  ...
  <div class="card-body">
    <h5 class="card-title">Typeathon is a speed typing web app to enhance user's typing speed effectively.</h5>
    <p class="card-text">This website was designed to improve user's typing speed and accuracy. Where user can track their typing performance with instant feedback, choose from different customizable typing modes to match their skill level and goals.</p>
  </div>
</div>
<div class="" style={{width:"34rem"}}>
  <div class="card-body">
    <p class="card-text">Multiple Typing Modes each designed to challenge users in unique. These modes are customizable, allowing users to select the test that best suits their needs.</p>
  </div>
</div>
<div class="" style={{width:"18rem"}}>
  <div class="card-body">
    <h5 class="card-title"><p style={{fontWeight:"800"}}>Live App 
...
<div  className=" blacktxtitem" >
     ...
     <div class="textcard">
    <p style={{fontWeight:"800"}}> Multi Typing Modes for free</p>
    <p>Maria Yasmeen</p>
  </div>
   </div>

   <motion.div    className='flex3boxes'   >
  <div class="" style={{width:"38rem"}}>
  <div class="card-body">
    <h5 class="card-title"> Design & Development</h5>
    <p class="card-text">Design: The user interface was crafted to be clean and simple, focusing on ease of use and minimizing distractions. The choice of colors and fonts was intentional to enhance readability and user engagement.

Development: The app was developed with a focus on responsiveness and performance. JavaScript was used to handle the typing test logic, while Firebase provided real-time capabilities and hosted the app.</p>
  </div>
</div>
 
  <div class="" style={{width:"38rem"}}>
  <div class="card-body">
    <h5 class="card-title"> Outcomes & Impact</h5>
    <p class="card-text"> Typeathon successfully achieved its goal of providing a robust platform for improving typing skills. The app's ability to deliver instant feedback and track progress has been well-received by users. The project has also allowed me to refine my skills in web development, particularly in integrating real-time features and creating a responsive design.
    </p>
  </div>
</div>
