...
Choose from different typing modes to match their skill level and goals.
                ...
                <div className="item"><h3>Key Features </h3>
                <p>
<h2>Multiple Typing Modes</h2>
<li>Variety of Tests: Typeathon offers different typing modes, each designed to challenge users in unique ways. These modes are customizable, allowing users to select the test that best suits their needs.</li>
Basic Mode: Simple text for beginners.
Advanced Mode: More complex text for seasoned typists.
Custom Mode: Users can input their own text for personalized practice.
Instant Results:
<h2>Instant Feedback:</h2>
<li>Real-Time Results: After each test, users receive immediate feedback on their typing speed (words per minute) and accuracy.</li>
...
<div className="txtscroll">
  ...
  <div class="card-body">
   ...
   <li>data authentication)</li>
                ...
                <div className="item"><h3>Design & Development</h3>
                <p>
  ...
  <ul class="comparecards">
    <li class="c-cards_item">
      <div class="c-card">
        ...
        <div class="c-card_content">
          <h2 class="c-card_title" style={{backgroundColor:"gold"}}>Challenges</h2>
    ...
    <li class="c-cards_item">
      <div class="c-card">
        ...
        <div class="c-card_content" >
          <h2 class="c-card_title" style={{backgroundColor:"pink"}}>Solutions</h2>
          <div class="c-card_text">
    ...
    <li class="c-cards_item">
      <div class="c-card">
        {/* <div class="c-card_image"><img src="https://assets.codepen.io/652/photo-1520174691701-bc555a3404ca.jpeg" alt="a Reuben sandwich on wax paper. " /></div> */}
        <div class="c-card_content" >
          <h2 class="c-card_title" style={{backgroundColor:"lightblue"}} >Results</h2>
          <div class="c-card_text">
